...
public class BoardPrint {
	...
	// 1. list 결과를 출력하는 메소드의 사용법 - BoardPrint.print(list)
	...
	// 2. view 결과를 출력하는 메소드의 사용법 - BoardPrint.print(list)
	...
	// 3. write, update, delete 결과를 출력하는 메소드 - 사용법 : BoardPrint.print(int 결과, String msg)
	// msg - 동작(글쓰기
